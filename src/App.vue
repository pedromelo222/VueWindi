          ...
          <WDropdown placement="bottom-end">
            ...
            <WMenu compact rounded horizontal="md" class="w-auto !bg-base-200">
              <WButton menu-item @click="changeColor('theme-default')"
                ><span class="rounded-full bg-blue-700 h-7 w-7"></span>
              </WButton>
              <WButton menu-item @click="changeColor('theme-teal')"
                ><span class="rounded-full bg-teal-700 h-7 w-7"></span>
              </WButton>
              <WButton menu-item @click="changeColor('theme-rose')"
                ><span class="rounded-full bg-rose-700 h-7 w-7"></span>
              </WButton>
              <WButton menu-item @click="changeColor('theme-violet')"
                ><span class="rounded-full bg-violet-700 h-7 w-7"></span>
              </WButton>
              <WButton menu-item @click="changeColor('theme-orange')"
                ><span class="rounded-full bg-orange-700 h-7 w-7"></span>
              </WButton>
            </WMenu>
          </WDropdown>

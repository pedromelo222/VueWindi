...
<template>
  <div
    ref="dropdownRef" class="w-dropdown" @mouseenter="mouseEnter" @mouseleave="mouseLeave"
  ...
  >
    ...
    <transition
      enter-active-class="w-transition-enter-active" enter-from-class="w-transition-enter-from"
    ...
    >
      <div
        v-show="isActive" class="w-dropdown-menu" :class="[
